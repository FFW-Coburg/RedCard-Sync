    ...
    private function mapPartnerToBonus(Partner $partner): array
    {
        ...
        return [
            ...
            'address' => [
                'country' => 'DE',
                'state' => 'Bayern',
                'city' => Str::limit($partner->city ?? '', 47, '...'),
                'zip_code' => Str::limit($partner->postal_code ?? '', 47, '...'),
                'street_address' => Str::limit($partner->street_address ?? '', 47, '...'),
                'additional' => '',
                'name' => Str::limit($partner->name, 47, '...'),
            ],
